...
const Accounts = () => {
  const accounts = [
    ...
    { id: '2', name: 'ATB Mastercard', type: 'Credit Card', balance: -1240.50, lastSync: '1 hour ago', status: 'connected' },
    { id: '3', name: 'Wealthsimple Invest', type: 'Investment', balance: 12450.00, lastSync: 'Today', status: 'connected' },
  ];
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-xl border border-indigo-100 dark:border-indigo-800 flex items-center gap-4">
        <div className="p-2 bg-white dark:bg-slate-900 rounded-lg text-indigo-600">
          <ShieldCheck size={24} />
        </div>
              ...
              <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center justify-between md:justify-end gap-8">
                  <div className="text-right">
                    <div className={`text-2xl font-black ${acc.balance < 0 ? 'text-red-500' : 'text-slate-900 dark:text-white'}`}>
